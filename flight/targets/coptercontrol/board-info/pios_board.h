...
#define PIOS_ADC_USE_TEMP_SENSOR		0   //H   1
#define PIOS_ADC_TEMP_SENSOR_ADC		ADC1
#define PIOS_ADC_TEMP_SENSOR_ADC_CHANNEL	1

#define PIOS_ADC_PIN1_GPIO_PORT			GPIOA			// PA4 (Gyro X)
#define PIOS_ADC_PIN1_GPIO_PIN			GPIO_Pin_2		// ADC12_IN4   H
#define PIOS_ADC_PIN1_GPIO_CHANNEL		ADC_Channel_2   //H    4
#define PIOS_ADC_PIN1_ADC			ADC1   //H    2
#define PIOS_ADC_PIN1_ADC_NUMBER		1

/*#define PIOS_ADC_PIN2_GPIO_PORT			GPIOA			// PA5 (Gyro Y)
#define PIOS_ADC_PIN2_GPIO_PIN			GPIO_Pin_2		// ADC123_IN5   H
#define PIOS_ADC_PIN2_GPIO_CHANNEL		ADC_Channel_2   //H   5
#define PIOS_ADC_PIN2_ADC			ADC1
#define PIOS_ADC_PIN2_ADC_NUMBER		1   //H   2*/
/*
...
#define PIOS_ADC_PIN3_ADC			ADC1   //  H   2
...
#define PIOS_ADC_NUM_ADC_CHANNELS		1   //H 2 
#define PIOS_ADC_USE_ADC2			0     //H 1
